# Onboard Computer Tutorial 04: Run Passive Board Bring-Up
...
**Run on:** the connected native Humble runtime on the onboard computer
...
Start with a fresh direct `ros2 launch` from Tutorial 03 in terminal A. Run this check
