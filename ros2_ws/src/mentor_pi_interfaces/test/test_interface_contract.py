...
EXPECTED_FIXED_ARRAYS = {
    ...
    ('SetMotorAdrc.srv', 'known_velocity_decay_rate_s_inverse'): 4,
    ('SetMotorAdrc.srv', 'input_gain_rps_per_second_per_permille'): 4,
    ('SetMotorAdrc.srv', 'controller_bandwidth_rad_s'): 4,
    ('SetMotorAdrc.srv', 'controller_fal_exponent'): 4,
    ('SetMotorAdrc.srv', 'controller_fal_threshold_rps'): 4,
    ('SetMotorAdrc.srv', 'observer_bandwidth_rad_s'): 4,
    ('SetMotorAdrc.srv', 'observer_velocity_fal_exponent'): 4,
    ('SetMotorAdrc.srv', 'observer_disturbance_fal_exponent'): 4,
    ('SetMotorAdrc.srv', 'observer_fal_threshold_rps'): 4,
    ('SetMotorAdrc.srv', 'disturbance_leakage_s_inverse'): 4,
    ('SetMotorAdrc.srv', 'disturbance_estimate_limit_rps_per_second'): 4,
    ('SetMotorAdrc.srv', 'velocity_filter_new_weight'): 4,
    ('SetMotorAdrc.srv', 'positive_minimum_drive_permille'): 4,
    ('SetMotorAdrc.srv', 'negative_minimum_drive_permille'): 4,
