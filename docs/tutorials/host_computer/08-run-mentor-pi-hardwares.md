...
**Run on:** normal development computer through the pinned Humble Docker runtime
...
Tracking remains disabled in both commands. To run the matching lower-level
tracker after its timing gate and time-synchronization check:
